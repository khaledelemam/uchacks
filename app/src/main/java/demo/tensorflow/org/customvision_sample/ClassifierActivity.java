        ...
        runInBackground(
                new Runnable() {
                    ...
                    public void run() {
                        ...
                        final  Classifier.Recognition r = classifier.classifyImage(rgbFrameBitmap, sensorOrientation);
...
//                        results.add(r);
//                        if (0.2 < r.getConfidence() && (r.getConfidence() < 0.8)) {
//                            System.out.println("Unable to classify");
//                            flag = false;
//                        } else if (r.getConfidence() > 0.8) {
//                            tag = "Go";
//                        } else {
//                            tag = "Stop";
//                        }
//
//                        if (flag) {
//                            System.out.println(r.getConfidence().toString());
//                        }
                        LOGGER.i("Confidence: " + r.getConfidence().toString());

                        LOGGER.i("Detect: %s", results);

                        if (r.getConfidence() > 0.50) {
                            results.add(r);
                        }
                        ...
                        if (r.getTitle().equals("Go")) {
                            LOGGER.i("Confidence: " + "GO");
                            ttobj.speak(r.getTitle(), TextToSpeech.QUEUE_FLUSH, null, null);
//                            ttobj.speak("Go", TextToSpeech.QUEUE_FLUSH, null);
                        }
                        else{
                            LOGGER.i("Confidence: " + "STOP");
                            ttobj.speak(r.getTitle(), TextToSpeech.QUEUE_FLUSH, null, null);
//                            ttobj.speak("Stop", TextToSpeech.QUEUE_FLUSH, null);
                        }
